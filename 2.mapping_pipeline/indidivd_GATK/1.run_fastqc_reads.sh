...
######sbatch /scratch/cat7ep/simCline/2.mapping_pipeline/individ_GATK/1.run_fastqc_reads.sh
#Load fastqc
module load fastqc

#change to folder containing reads
cd /scratch/cat7ep/simCline/fasterq

#Make an array of all folder containing reads
files=*
#echo ${files}
#set output directory
outdir="/scratch/cat7ep/simCline/fasterq"
...
singularity run /scratch/cat7ep/simCline/individPipeline/multiqc.sif ./
